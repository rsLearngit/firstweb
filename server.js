...
//Quary String / parameter 에 대하여 알아보자
//get / post
...
server.get('/cal', (req, res, next) =>{
    ...
    if(req.query.thirdNum !== null && req.query.thirdNum !== undefined){
        Nums.thirdNum = Number(req.query.thirdNum);
    }
  
    var temp = "test"; // 0
    console.log('합은 : ' + ((Nums.firstNum + Nums.secondNum) * Nums.thirdNum) + '입니다.')
